<div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="index.html">
              {{-- <img alt="image" src="{{ asset ('admin_ality/assets/img/logo.png') }}" class="header-logo" /> --}}
              <span class="logo-name">Admin</span>
            </a>
          </div>
          <ul class="sidebar-menu">
            <li class="menu-header">Main</li>
            <li class=""><a class="nav-link" href="{{route('index.dashboard')}}"><i class="fas fa-home"></i><span>Dashboard</span></a></li>
            {{-- <li class=""><a class="nav-link" href="{{route('index.brand')}}"><i class="fas fa-stream"></i><span>Brand</span></a></li> --}}
            {{-- <li class=""><a class="nav-link" href="{{route('index.kategori')}}"><i class="fas fa-stream"></i><span>Kategori</span></a></li> --}}
            {{-- <li class=""><a class="nav-link" href="{{route('index.produk')}}"><i class="fas fa-stream"></i><span>Produk</span></a></li> --}}
            <li class=""><a class="nav-link" href="{{route('logout')}}"><i class="fas fa-power-off"></i><span>Log Out</span></a></li>
            {{-- <li class="dropdown">
